        ...
        stage('Build Test Deploy') {
            ...
            stages{
                ...
                stage('Deploy') {
                    ...
                    steps {
                        sh 'podman login -u $DOCKER_HUB_CREDS_USR -p $DOCKER_HUB_CREDS_PWD docker.io && skopeo copy containers-storage:localhost/eemb174 docker://docker.io/ucsb/eemb174-274'
                    }
                }                
            }
        }
